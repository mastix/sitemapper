...
var gunzip = bb.promisify(require('zlib').gunzip);
        ...
        value: function parse() {
            ...
            return new _es6Promise.Promise(function (resolve) {
                ...
                var requester = (0, _requestPromise2['default'])(requestOptions).then(function (response) {
                    ...
                    //Gzipped sitemap handling...

                    return gunzip(response.body).then(function (contents) {

                        return (0, _xml2jsEs6Promise2['default'])(contents.toString());
